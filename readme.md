...
ms.locfileid: "137898873"
---
# <a name="pl-900-power-platform-fundamentals"></a>PL-900：Power Platform 基础知识
...
- 为了支持本课程，我们需要经常更新课程内容，让课程内容与课程中使用的 Power Platform 服务保持同步。  我们将在 GitHub 上发布实验室说明和实验室文件，以允许课程作者和 MCT 之间公开参与，以使内容与平台的变化保持同步。
