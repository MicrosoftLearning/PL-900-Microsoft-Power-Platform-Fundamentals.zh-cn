...
4.  配置权限以显示建筑物列表 
    ...
    -   从左侧菜单中，单击“**设置**”（齿轮符号）并选择“**查看更多**”设置。这将在新选项卡中打开其他设置。

    -   在左侧菜单中，向下滚动到“**安全性**”并选择“**表权限**”。

    -   单击“**新建**”并添加以下值：

        -   **名称**：显示建筑物列表
        -   **表名**：从右侧下拉列表中选择“建筑物(bc_building)”
        -   **网站**：单击放大镜并选择你的网站（Bellows College 访客 - [你的姓名]）
        -   **访问类型**：全局
        -   **权限**：读取
    
    -   从顶部菜单，选择“**保存**”。
    
    -   向下滚动到“**Web 角色**”部分和“**添加现有 Web 角色**”。
