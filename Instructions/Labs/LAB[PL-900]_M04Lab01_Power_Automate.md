...
2.  单击“**新建**”，然后依次选择“**自动化**”、“**云端流**”和“**自动**”。这将在新窗口中打开 Power Automate 流编辑器。

3. 在“**选择流的触发器**”中，搜索“**Microsoft Dataverse**”。

4. 选择“**添加、修改或删除行时**”触发器，然后单击“**创建**”。
   ...
   * 在触发步骤上，单击省略号 (**…**)，然后单击“**重命名**”。将此触发器重命名为“**添加访问时**”。这是一个很好的做法，这样你和其他流编辑器可以理解该步骤的目的，而不必深入研究细节。
...
2. 单击“**新建**”，然后依次选择“**自动化**”、“**云端流**”和“**计划**”。这将在新窗口中打开 Power Automate 流编辑器。
...
13.  在“**正文**”字段中输入以下内容。“**名称**”是来自“**获取建筑物**”步骤的动态内容。你可能需要滚动到列表底部。
