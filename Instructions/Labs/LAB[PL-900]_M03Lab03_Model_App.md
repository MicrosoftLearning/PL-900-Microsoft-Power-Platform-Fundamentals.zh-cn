...
**重要提示：** 由于默认情况下所有表单都称为“信息”，因此请确保验证所选表单的表单类型为“主要”而不是其他类型。 默认情况下，该表单具有两个字段：“名称”（主字段）和“所有者”。
...
3. 创建模型驱动应用程序：
    ...
    0. 在“主页”屏幕的“开始”部分中选择“空白应用” 。

    1. 在“基于 Dataverse 的空白应用”下，选择“创建” 。

    2. 输入“Bellows 校园管理”作为名称，然后选择“创建” 。
...
2. 新建“Contact”
    ...
    2. 在“名字”中输入“John”，在“姓氏”中输入“Doe” 。

    3. 在“电子邮件”中输入你的个人电子邮件。 这将在将来的实验室中使用，你将收到一封电子邮件。

    4. 单击“保存并关闭”。

    5. 现在应该可以在“可用联系人”视图中看到创建的联系人。
...
3. 新建“Visit”
    ...
    2. 输入以下字段
        ...
        2. **计划开始时间**：选择明天的日期和下午 2:00 作为开始时间

        3. **计划结束时间**：选择明天的日期和下午 3:30 作为结束时间
