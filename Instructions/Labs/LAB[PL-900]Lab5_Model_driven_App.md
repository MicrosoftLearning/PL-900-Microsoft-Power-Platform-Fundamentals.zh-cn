...
2.  使用左侧导航栏，选择“**解决方案**”。
3.  打开之前创建的“活动管理”解决方案****。
4.  在命令栏上，选择“新建”\>“应用”\>“模型驱动应用”****************。
5.  选择“创建”部分****。
    -   **名称：** Contoso 活动管理
    -   **说明：** 用于管理活动和活动会议。
6.  选择“创建”按钮。********
7.  选择“添加页面”按钮，然后选择“Dataverse 表”********。
8.  选择下表：
    -   联系人
    -   活动
    -   事件会话
...
4.  选择“人员”组中的省略号********。
5.  选择“新建组”****。
6.  在“属性”窗格中，将组的名称从“新建组”更改为“活动”************。
7.  将鼠标悬停在左侧的“会议报名”视图上，选择省略号，然后选择“下移”，将“会议报名”移动到“活动”组中********************。
8.  将鼠标悬停在左侧的“活动会议”视图上，选择省略号，然后选择“下移”，将“活动会议”移动到“活动”组中********************。
9.  将鼠标悬停在左侧的“活动”视图上，选择省略号，然后选择“下移”，将“活动”移动到“活动”组中********************。
...
2.  在屏幕左侧的“人员”组下，将鼠标悬停在“联系人”窗体上，然后选择“编辑”************。
...
4.  按如下所示配置表列：
    ...
    -   数据类型：**** 选项
    -   是否与全局选项同步：**** 否
5.  将第一个选项的“标签”设置为“演讲者”********。
6.  选择“+ 新建选项”，然后将标签设置为“参与者”********。
7.  选择“+ 新建选项”，然后将标签设置为“支持人员”********。

![“联系人类型”列的屏幕截图。](media/b1982b779d91cf134b41b6f445b8f07c.png)

8.  选择“保存”按钮。****
9.  使用鼠标，选择“新建联系人”文本以选择窗体页眉****。 （页眉周围应显示紫色矩形）**
10. 在“表列”下的“搜索”字段中，输入“联系人”************。
11. 选择刚刚创建的“联系人类型”表列****。
12. “联系人类型”现在应显示在页眉中********。

![显示窗体上的“联系人类型”字段的屏幕截图。](media/4debe7a09e460f79c1cb05a6824dad66.png)

13. 在窗体命令栏上，选择“保存并发布”按钮********。
14. 选择“后退箭头”按钮以返回到模型驱动应用程序设计器****
15. 在左侧“导航”下，将鼠标悬停在“联系人”视图上，然后选择“编辑”图标************。 （如果系统提示保存，请选择“保存并继续”。****）
16. 选择“+ 查看列”****。
17. 搜索“联系人类型”列并将其添加到视图中****。
18. 选择**保存并发布**按钮。
19. 选择“后退箭头”按钮以返回到模型驱动应用程序设计器****。
...
21.  将鼠标悬停在“活动”视图上，然后选择“编辑”按钮********。

当系统提示保存更改时，请选择“保存并继续”********。

22.  在“视图”上，选择“EventDetails1”旁边的箭头，然后从显示的菜单中选择“移除”************。

![显示如何从视图中移除额外列的屏幕截图。](media/f0f1484a4f3a679abc18cdb1cd5c04da.png)

23.  选择**保存并发布**按钮。
24.  选择“后退箭头”按钮以返回到应用程序设计器****。
25.  在“导航”下，将鼠标悬停在“活动”窗体上，然后选择“编辑”****************。

当系统提示保存更改时，请选择“保存并继续”****。

26.  选择“Event Details1”字段，然后按键盘上的删除键********。
...
27.  选择“**保存并发布**”按钮。
28.  选择“后退箭头”按钮以返回到应用程序设计器****。

## 任务 4：保存并发布（如果窗体上没有“EventDetail1”字段，请在此处继续。

1.  在应用的命令栏上，选择“保存并发布”按钮********。
2.  选择“后退”按钮以返回到“活动管理”解决方案********。
3.  选择“返回解决方案”箭头，返回到 Power Apps Maker Portal********。
4.  选择后退箭头以返回到 Power Apps 主屏幕********。
...
3.  将鼠标悬停在刚刚创建的“活动管理”应用程序上，然后选择“运行”图标********。
4.  使用左侧导航栏，选择“联系人”****。
5.  在命令栏上，选择“+ 新建”按钮********。
