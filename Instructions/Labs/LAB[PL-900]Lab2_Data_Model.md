...
> **注意：** 如果在使用 Copilot 创建选项列时，表上出现“需要注意”错误消息，可以按照以下步骤手动创建列：****
1. 选择“视图选项”，然后选择“查看数据”。******** 表结构将变为可见。
1. 单击“+ 新建列”**** 以添加新列。
...
1.  在 Power Apps 主屏幕上，使用左侧的导航栏选择“表”****。
...
1.  如果表包含额外的列，则通过输入 `Delete the [column name] column.`** 来删除这些列
1.  在表与该图匹配后，选择“保存并退出”****。
